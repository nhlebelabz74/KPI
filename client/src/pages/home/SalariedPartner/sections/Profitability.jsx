...
const HoursSection = () => {
  const billableHoursTarget = 1800; // Annual billable hours for Salaried Partner
  const nonBillableHoursTarget = 250; // Annual non-billable for Salaried Partner
  const writtenOffHoursTarget = 0.05 * billableHoursTarget; // Max 5% written off (same calculation)
  ...
  const KPIS = {
    billableHours: {
      number: '1.4.1',
      question: 'Annual billable hours target (1800 hours)',
    },
    nonBillableHours: {
      number: '1.4.2', 
      question: 'Annual non-billable hours target (250 hours)',
    },
    writtenOffHours: {
      number: '1.4.3',
      ...
      <CardContent>
        <div className='flex flex-col gap-5'>
          ...
          <div className='flex flex-col gap-2'>
            <Label htmlFor="billableHours">Billable Hours (Target: 1,800 hours)</Label>
          ...
          {/* Non-Billable Hours */}
          <div className='flex flex-col gap-2'>
            <Label htmlFor="nonBillableHours">Non-Billable Hours (Target: 250 hours)</Label>
...
const ComplianceAndPromotionSection = () => {
  ...
  // Salaried Partner specific targets
  // For Salaried Partner, compliance target is 100% (1.4.3.1)
  const complianceTarget = (TOTAL_ANNUAL_BUDGET || 0) * 1.0;
  
  // For promotion, target is 175% of budget (1.4.4.1)
  const promotionThreshold = (TOTAL_ANNUAL_BUDGET || 0) * 1.75;
  
  // Goodwill targets (30% of budget for compliance, 40% for promotion) (1.4.3.2, 1.4.4.2)
  const goodwillComplianceTarget = (TOTAL_ANNUAL_BUDGET || 0) * 0.3;
  const goodwillPromotionTarget = (TOTAL_ANNUAL_BUDGET || 0) * 0.4;
  ...
  const GOODWILL_KPI = {
    number: '1.4.3.2',
    question: 'Goodwill amount (30% of budget for compliance, 40% for promotion)',
  };
  ...
  const progressToCompliance = complianceTarget > 0 
    ? (totalBilledAmount / complianceTarget) * 100 
    : 0;
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      {/* Compliance and Promotion Card */}
      <Card>
        <CardHeader>
          <CardTitle>Compliance and Promotion Targets</CardTitle>
          <CardDescription>
            Compliance Target: 100% of {(TOTAL_ANNUAL_BUDGET || 0).toLocaleString()}
          </CardDescription>
        </CardHeader>
...
const Profitability = () => {
  const KPI_CONFIG = [
    {
      number: '1.4.6',
      title: 'Manages Department Financial Performance',
      description: 'Achieves own and assists others in managing department\'s financial performance targets',
    ...
    {
      number: '1.4.7',
      title: 'Develop Team Expertise',
      description: 'Consistently achieves their rates to reflect their expertise',
      text_placeholder: 'Describe how you meet this requirement...',
      withProgress: [],
      withCheckBox: []
    },
    {
      ...
      description: 'Undertakes sector best work and ensures other work is carried out at the most profitable level/time permitted',
      text_placeholder: 'Describe how you meet this requirement...',
      withProgress: [],
      withCheckBox: []
    },
    {
      ...
      description: 'Supports department in scoping work efficiently and checking matter profitability, and has difficult conversations with clients where necessary',
      text_placeholder: 'Describe how you meet this requirement...',
      withProgress: [],
      withCheckBox: []
    },
    {
      ...
      description: 'Demonstrates a thorough understanding of pricing approach/parameters and uses available resources to maximize results',
      text_placeholder: 'Describe how you meet this requirement...',
      withProgress: [],
      withCheckBox: []
    },
    {
      number: '1.4.11',
      title: 'Business Plan Implementation',
      description: 'Delivers key aspects of the department\'s business plan alongside high personal financial performance',
      text_placeholder: 'Describe how you meet this requirement...',
      withProgress: [],
      withCheckBox: []
    },
    {
      ...
      description: 'Utilizes resources in own and other departments to ensure a collaborative profitable approach',
      text_placeholder: 'Describe how you meet this requirement...',
      withProgress: [],
      withCheckBox: []
    },
    {
      ...
      description: 'Takes responsibility for risk and resourcing of matters and SLA\'s and addresses issues of concern',
      text_placeholder: 'Describe how you meet this requirement...',
      withProgress: [],
      withCheckBox: []
    },
    {
      ...
      description: 'Takes responsibility and HR priorities',
      text_placeholder: 'Describe how you meet this requirement...',
      withProgress: [],
      withCheckBox: []
    }
